...
function displayQuote(quoteObj){
    let quoteHtml = `<p class="quote-text">${quoteObj.quote}</p>`;
    let authorHtml = `
                   <div class="author">
                   <p>${quoteObj.author}</p>
                   <p>${quoteObj.profession}</p>
                   <p>Topic: ${quoteObj.topics[Math.floor(Math.random() * quoteObj.topics.length)]}</p>
                   </div>
    `;
    let quoteDiv = `
                      ${quoteHtml}
