...
import { addReplyOnComment, commentOnPost } from '../features/posts/postsSlice';

function CreateComment({ post, parentComment }) {
  ...
  const handleCommentSubmit = () => {
    ...
    if(parentComment ){
      dispatch(addReplyOnComment({comment :  commentObject}))
    }
